...
import {multideal, multinodeal} from "../../api/soc";
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          "width": 800,
          'render': function (row){
            return `<img height=300px src="data:image/png;base64,${row.screenshot}"><br>${row.url}`
          },
        },
        {
          'name': 'uploaddate',
